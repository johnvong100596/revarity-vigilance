...
- **All migrations applied to prod (6 total tonight):** billing tables, RLS hardening, revarity comp, fx widen, snapshot index, signup-regression fix. tsc+lint+build green throughout.
